...
class Scoring:
    ...
    Calculat score.
    """
    def mut(proba_delta: JSON, method="euclidean", proba_simple: JSON | None = None)->float:
        """
        ...
        for key in ("acceptor_proba", "donor_proba"): #proba
            ...
            for i in proba_delta_ad:
                match method:
                    case "euclidean" | "manhattan" | "quadratic":
